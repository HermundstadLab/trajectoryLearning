function [xBoundary,yBoundary,heading,indSegments,binSegments] = getBoundary(xBounds,yBounds,np)
% GETBOUNDARY Returns densely-sampled coordinates of rectangular area.
%   [xBounds,yBounds,heading,indSegments,binSegments] = GETBOUNDS(xBounds,yBounds,np) 
