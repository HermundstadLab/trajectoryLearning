...
%       res = runSingleAgent(arena,belief,sampler,planner,trial);
%
...
addpath("auxiliaryFunctions/","auxiliaryFunctions/peaks2/","plottingFunctions/","sims/");


%% generate basic structures for environment, trial protocol, and agent

% default parameter values for plotting are specified in the function
% 'loadPlotParams'; default parameter values for specifying the
...
% this loads an example agent that was trained on 10 trials
