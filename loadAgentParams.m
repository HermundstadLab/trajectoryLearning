...
if strcmp(agentType,'default')
    ...
    planner.nxObstacle  = floor(belief.np/2);               % number of spatial points per unit length used to
    ...
    planner.boundaryVelocity = planner.nInterp./...         % velocity at which agent moves along obstacle boundaries
        (planner.nxObstacle-1);                             %   (this should be sufficiently fast; will o/w burn obstacle boundary into posterior)
